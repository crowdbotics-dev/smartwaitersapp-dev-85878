...
## Project Structure
    ...
    ├── smartwaitersapp_dev_85878  # Django project configurations
...
1. Clone this repo and `cd smartwaitersapp_dev_85878`
...
2. Clone this repo and `cd smartwaitersapp_dev_85878`
